...
const originalPrompt = window.prompt,
	originalConfirmation = window.confirm,
...
/**
 * Gets the frame location path from current window to top
 * @returns {string} Frame location path
 */
...
// Dialog function overrides for non-top windows
if (window !== window.top) {
	...
	// Dialog function overrides for top window
	window.prompt = function (text, defaultText) {
		recordedPrompt = text;
...
/**
 * Handles messages from content script to control dialog behavior
 * @param {MessageEvent} event - Message event from content script
 */
...
// Setup message handler for top window
if (window === window.top) {
